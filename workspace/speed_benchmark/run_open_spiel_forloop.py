...
if __name__ == "__main__":
    ...
    print(json.dumps({"game": args.env_name, "library": "open_spiel/for-loop", "total_steps": steps_num, "total_sec": sec, "steps/sec": steps_num/sec, "batch_size": args.batch_size}))
