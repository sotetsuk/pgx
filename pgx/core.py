...
class Env(abc.ABC):
    ...
    def observe(self, state: State, player_idArray) -> jax.Array:
    ...
    @abc.abstractmethod
    def _observe(self, state: State, player_idArray) -> jax.Array:
