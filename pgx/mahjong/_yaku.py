...
class Yaku:
    ...
    @staticmethod
    def is_pure_straight(chowArray) -> jax.Array:
        return (
    ...
    @staticmethod
    def is_triple_chow(chowArray) -> jax.Array:
        return (
    ...
    @staticmethod
    def is_triple_pung(pungArray) -> jax.Array:
        return (
    ...
    @staticmethod
    def flatten(handArray, meldsArray, n_meld) -> jax.Array:
    ...
    @staticmethod
    def _flatten(handArray, meld) -> jax.Array:
