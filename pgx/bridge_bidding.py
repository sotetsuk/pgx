...
class BridgeBidding(v1.Env):
    def __init__(self):
        ...
        # fmt: ons
        self.dds_hash_table: str = os.getcwd() + "/dds_hash_table"
        self.hash_keys = jnp.load(self.dds_hash_table + "/keys.npy")
        self.hash_values = jnp.load(self.dds_hash_table + "/values.npy")
