...
def test_step():
    board = np.zeros((29, 81), dtype=np.int32)
    board = board.at[0] = np.ones(81, dtype=np.int32)
...
def test_pin():
    ...
    s2.board[22,40].set(1)
    s2.board[0,40].set(0)
    s2.board[14,38].set(1)
    s2.board[0,38].set(0)
    s2.board[23,39].set(1)
    s2.board[0,39].set(0)
    s2.board[5,64].set(1)
    s2.board[0,64].set(0)
    s2.board[15,56].set(1)
    s2.board[0,56].set(0)
    s2.board[6,76].set(1)
    s2.board[0,76].set(0)
    s2.board[20,67].set(1)
    s2.board[0,67].set(0)
    s2.board[26,58].set(1)
    s2.board[0,58].set(0)
    s2.board[13,80].set(1)
    s2.board[0,80].set(0)
    s2.board[17,50].set(1)
    s2.board[0,50].set(0)
    s2.board[2,44].set(1)
    s2.board[0,44].set(0)
    s2.board[17,42].set(1)
    s2.board[0,42].set(0)
    s2.turn = 1
    pins2 = _pin(s2)
    assert pins2[39] == 1
