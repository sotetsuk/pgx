...
Note that the [MinAtar](https://github.com/kenjyoung/MinAtar) suite is provided as a separate extension for Pgx. Therefore, please run the following command additionaly to use the MinAtar suite in Pgx:
