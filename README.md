...
|<a href="https://en.wikipedia.org/wiki/Backgammon">Backgammon</a><br>`"backgammon"` |<img src="docs/assets/backgammon_dark.gif" width="60px"><img src="docs/assets/backgammon_light.gif" width="60px">| `v0` | Dice and strategy board game. |
|<a href="https://en.wikipedia.org/wiki/Chess">Chess</a><br>`"chess"` |<img src="docs/assets/chess_dark.gif" width="60px"><img src="docs/assets/chess_light.gif" width="60px">| `v0` | *Classic board game of strategy.* |
|<a href="https://en.wikipedia.org/wiki/Connect_Four">Connect Four</a><br>`"connect_four"` |<img src="docs/assets/connect_four_dark.gif" width="60px"><img src="docs/assets/connect_four_light.gif" width="60px">| `v0` | *Connect four in a row.* |
...
|<a href="https://github.com/kenjyoung/MinAtar">MinAtar/Asterix</a><br>`"minatar-asterix"` |<img src="docs/assets/minatar-asterix.gif" width="50px">| `v0` | *Adventure game with increasing difficulty.* |
