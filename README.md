...
graph LR;
    ...
    _step --> _step_drop;
    _step --> _flip;
    _step --> _major_piece_ix;
    _step --> _set_cache;
    _step --> _legal_action_mask;
    _legal_action_mask --> _is_checked;
    _legal_action_mask --> _is_drop_pawn_mate;
    _legal_action_mask --> _is_legal_drop_wo_piece;
    _legal_action_mask --> _is_legal_drop_wo_ignoring_check;
    _legal_action_mask --> _is_legal_move_wo_pro;
    _legal_action_mask --> _is_no_promotion_legal;
    _legal_action_mask --> _is_promotion_legal;
    _is_checked --> _is_pseudo_legal_move;
    _is_drop_pawn_mate --> _flip;
    _is_drop_pawn_mate --> _legal_action_mask;
    _set_cache --> _is_major_piece;
    _set_cache --> _is_major_piece_ix;
    _step --> _is_pseudo_legal_move;
    _is_pseudo_legal_move --> _is_pseudo_legal_move_wo_obstacles;
    _is_pseudo_legal_move --> _major_piece_ix;
    _observe --> pieces;
    _observe --> effect_all;
    _observe --> piece_and_effect;
    _observe --> hand_feat;
    _observe --> _set_cache;
    effect_all --> effect;
    piece_and_effect --> filter_effect;
    hand_feat --> num_hand;
    _flip --> _rotate;
    _flip --> _flip_piece;
    _is_major_piece --> _major_piece_ix;
```