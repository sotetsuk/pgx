...
![](./go_dark.gif#gh-dark-mode-only)
![](./go_light.gif#gh-light-mode-only)
![](./go_dark.gif#gh-dark-mode-only)
![](./go_light.gif#gh-light-mode-only)

<!---
<div align="center">
<img src="fig/go_light.gif" width="40%"><img src="fig/go_light.gif" width="40%" style="transform:rotate(180deg);">
</div>
--->
